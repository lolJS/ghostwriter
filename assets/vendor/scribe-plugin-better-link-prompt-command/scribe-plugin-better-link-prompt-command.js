define('scribe-plugin-better-link-prompt-command',[],function () {

  /**
   * This plugin adds a command for creating links, including a basic prompt. Also supports removing links
   */
    ...
    return function (scribe) {
      ...
      linkPromptCommand.execute = function () {
        ...
        if (initialLink == 'http://') {
          ...
          initialLink.unwrap(anchorNode.parentNode, anchorNode);
